...
export default class MailerServiceFile {
  ...
  public async TwoFactorAuthenticate(email: string, firstName: string, userCode: number): Promise<void> {
    try {
      ...
      logger.error('MailerService.TwoFactorAuthenticate => ', error);
      throw new MailerError();
    }
  }
  ...
  public async Invoice({
    ...
    try {
      ...
      logger.error('MailerService.Invoice => ' + error);
      throw new MailerError();
    }
  }
  ...
  public async Update_subscription({
    ...
    try {
      ...
      logger.error('MailerService.Update_subscription => ', error);
      throw new MailerError();
    }
  }
  ...
  public async Delete_subscription({
    ...
    try {
      ...
      logger.error('MailerService.Delete_subscription => ', error);
      throw new MailerError();
    }
  }
  ...
  public async New_invoice({
    ...
    try {
      ...
      logger.error('MailerService.New_invoice => ', error);
      throw new MailerError();
    }
  }
  ...
  public async Failed_subscription({
    ...
    try {
      ...
      logger.error('MailerService.Failed_subscription => ', error);
      throw new MailerError();
    }
  }
  ...
  public async Cancel_request({
    ...
    try {
      ...
      logger.error('MailerService.Cancel_request => ', error);
      throw new MailerError();
    }
  }
